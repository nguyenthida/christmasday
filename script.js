...
//    if (mm <= 9 && hh >= 10) {
//       document.querySelector('.tempo').innerHTML = `${hh}:0${mm}`
//    }

//    else if (hh <= 9 && mm >= 10) {
//       document.querySelector('.tempo').innerHTML = `0${hh}:${mm}`
//    }

//    else if (hh <= 9 && mm <= 9) {
//       document.querySelector('.tempo').innerHTML = `0${hh}:0${mm}`
//    }

//    else if (hh >= 10 && mm >= 10) {
//       document.querySelector('.tempo').innerHTML = `${hh}:${mm}`
//    }
